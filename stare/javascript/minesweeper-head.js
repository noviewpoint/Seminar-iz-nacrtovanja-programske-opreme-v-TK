...
globalState = 0;
rightOrLeftClick = 0;//hrani vrednost, ki programu sporoči, da je bil izveden levi oz. desni klik
alternativePlay = 0;//za aktiviranje mobilnega načina, prvič mora uporabnik pritisniti števec min, nadaljne pa prazno polje
...
function drawFieldsHTML() {
	...
	_("space_game").classList.remove("invisible");

	_("gameFields").classList.remove("invisible");

	_("timer").innerHTML = "";
	_("mr_smiley").className = "play";
	_("counter").innerHTML = "";
	_("submitScore").classList.add("invisible");
	//_("gameFields").style.display= "initial";//povrne nazaj iz display:none
	//_("aaa").style.display = "initial";
	//_("highscores").style.display = "none";
...
function obZmagi() {
	_("gameFields").classList.add("invisible");
	_("submitScore").classList.remove("invisible");//spodaj uporaba --> \
